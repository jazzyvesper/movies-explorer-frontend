    ...
    <div className="form__container">
      ...
      <form className="form__info" onSubmit={props.onSubmit} >
        ...
        {props.children}
          ...
          <input type="email" onChange={props.onChangeEmail} value={email || ''} placeholder="" className="form__item form__item_type_email" name="email" id="email" required/>
          <span className="email-error form__item-error"></span>
          <label className="input__label" htmlFor="password">Пароль</label>
          <input type="text" onChange={props.onChangePassword} value={password || ''} placeholder="" className="form__item form__item_type_password" name="password" id="password" required minLength="8" maxLength="40"/>
